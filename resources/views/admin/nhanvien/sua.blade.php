            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px ;width:700px;">
                        ...
                        <form action="{{URL::to('admin/nhanvien/sua/'.$nhanvien[0]->manhanvien)}}" enctype="multipart/form-data" method="POST">
                            <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                        <div style="float: left;width: 318px;">
                            <div class="form-group">
                                <label>Mã nhân viên</label>
                                <input disabled type="text" class="form-control" value="{{$nhanvien[0]->manhanvien}}"  name='manhanvien' placeholder="Nhập mã nhân viên">
                            </div>
                            <div class="form-group">
                                <label>Tên nhân viên</label>
                                <input type="text" class="form-control" value="{{$nhanvien[0]->tennhanvien}}"   name='tennhanvien' placeholder="Nhập tên nhân viên">
                            </div>
                            <div class="form-group">
                                <label>Giới tính</label>
                                <div class="radio">
                                    
                                    <label><input type="radio" name="gioitinh" value="1" @if($nhanvien[0]->gioitinh==1){{"checked"}}@endif>Nam</label>
                                </div>
                                <div class="radio">
                                    <label><input type="radio" name="gioitinh" value="0" @if($nhanvien[0]->gioitinh==0){{"checked"}}@endif>Nữ</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Địa chỉ</label>
                                <input type="text" class="form-control" value="{{$nhanvien[0]->diachi}}"  name='diachi' placeholder="Nhập địa chỉ nhân viên">
                            </div>
                            <div class="form-group">
                        ...
                        <div style="float: right;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" value="{{$nhanvien[0]->ngayvaolam}}" name='ngayvaolam' placeholder="Nhập ngày vào làm">
                            </div>
                            <div class="form-group">
